        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        help_text="User who sent the notification (null for system)",
                        null=True,
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="websocket_n_recipie_d1d267_idx",
                    ),
                    models.Index(fields=["type"], name="websocket_n_type_945381_idx"),
                    models.Index(
                        fields=["created_at"], name="websocket_n_created_54916b_idx"
                    ),
                    models.Index(
                        fields=["priority"], name="websocket_n_priorit_feb575_idx"
                    ),
                ],
            },
        ),
