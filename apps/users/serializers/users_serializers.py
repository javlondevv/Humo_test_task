...
class UserCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'role', 'gender', 'phone_number', 'first_name', 'last_name'
        ]
        extra_kwargs = {
            'username': {
...
class UserDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'role', 'role_display', 'gender', 'gender_display',
            'phone_number', 'is_active', 'date_joined',
            'is_client', 'is_worker', 'is_admin'
        ]
        read_only_fields = [
...
class UserFilterSerializer(serializers.Serializer):
    ...
    gender = serializers.ChoiceField(
        ...
        required=False,
        help_text='Filter by user gender'
    )
    ...
    date_from = serializers.DateField(
        required=False,
        help_text='Filter users joined from this date'
    )
    
    date_to = serializers.DateField(
        required=False,
        help_text='Filter users joined until this date'
    )
