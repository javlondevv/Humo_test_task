...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            type=str,
            default='',
            help='First name of the worker'
        )
        parser.add_argument(
            '--last-name',
            type=str,
            default='',
            help='Last name of the worker'
        )
        parser.add_argument(
            '--gender',
            type=str,
        ...
        parser.add_argument(
            ...
            type=str,
            default='',
            help='Phone number of the worker'
        )
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            self.stdout.write(
                self.style.ERROR(f'Failed to create worker user: {e}')
            )
