...
class UserService:
    ...
    def get_workers_by_gender(gender: str, requesting_user: User) -> List[User]:
        ...
        return (
            User.objects.filter(role=User.Role.WORKER, gender=gender, is_active=True)
            .select_related()
            .only(
                "id",
                "username",
    ...
    @staticmethod
    def update_user(user: User, requesting_user: User, **kwargs) -> User:
        """
    ...
    def change_user_password(
        user: User, requesting_user: User, new_password: str
    ) -> bool:
        """
        ...
        try:
            ...
            logger.info(
                f"Password changed for user {user.id} by user {requesting_user.id}"
            )
            return True
    ...
    @staticmethod
    def deactivate_user(user: User, requesting_user: User, reason: str = "") -> bool:
        """
        ...
        try:
            ...
            logger.info(
                f"User {user.id} deactivated by admin {requesting_user.id}. Reason: {reason}"
            )
            return True
    ...
    @staticmethod
    def activate_user(user: User, requesting_user: User) -> bool:
        """
